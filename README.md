...
-   **Gesture-Based Control**:
    ...
    -   ✊ **Pan Model**: Fist (Four fingers curled)
    -   📏 **Scale Model**: Pinky finger pinch
    -   🔄 **Toggle Variant**: Ring finger pinch
    -   ✌️ **Toggle Hand Mode**: Peace Sign (Hold 2s)
...
| **Fist** | **Pan Model** | Curl all fingers into a fist, move hand to drag the model. |
| **Pinky Pinch** | **Scale Model** | Pinch thumb & pinky, move up to enlarge, down to shrink. |
| **Ring Pinch** | **Toggle Variant** | Pinch thumb & ring finger to switch between model versions. |
| **Peace Sign** | **Hand Mode** | Hold Peace Sign for 2s to toggle One/Two-handed mode. |
